...
import { createProcess } from './routes/create-process.js';
import { createProcessMovement } from './routes/create-process-movement.js';
...
import { deleteProcess } from './routes/delete-process.js';
...
import { listProcesses } from './routes/list-processes.js';
import { listProcessMovements } from './routes/list-process-movements.js';
...
import { updateProcess } from './routes/update-process.js';
...
await server.register(listProcesses);
await server.register(getProcess);
await server.register(createProcess);
await server.register(updateProcess);
await server.register(deleteProcess);
await server.register(listProcessMovements);
await server.register(createProcessMovement);
